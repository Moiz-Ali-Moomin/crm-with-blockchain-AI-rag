...
async function main() {
  ...
  const leadsRaw = [
    ...
    { firstName: 'Ahmed',     lastName: 'Hassan',    email: 'a.hassan@metatech.io',      phone: '+1-408-555-0231', companyName: 'MetaTech IO',          jobTitle: 'CEO',             source: 'LINKEDIN',      status: 'CONTACTED',  score: 71,  notes: 'Responded to LinkedIn outreach. 45-min discovery call scheduled for next week.',                                 assigneeId: salesRep3.id,  createdAt: daysAgo(7),  lastContactedAt: daysAgo(5),  tags: ['outbound', 'linkedin', 'call-scheduled'] },
